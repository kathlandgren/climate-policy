...
def sample_df(df, frac_replace):
    ...
    # Flatten the DataFrame to a 1D array for easier manipulation
    ...
    for index in indices_to_replace:
        row_index, col_index = divmod(index, Q_sampled.shape[1])  # Map 1D index to 2D
...
def get_pair_counter(Q3_df):
    ...
    # Iterate over each column to find pairs of annotators
...
def get_matrix_df(pair_counter):
    ...
    # Populate the DataFrame with pair counts
